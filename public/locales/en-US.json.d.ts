interface EnUS {
  ...
  settings: {
    ...
    sections: {
      ...
      miniPlayer: {
        enableMiniPlayerButton: {
          label: 'Mini player button',
          title: 'Adds a button to the feature menu to open the video in a mini player'
        },
        openWhenScrollingDown: {
          label: 'Open mini player when scrolling to comments',
          title: 'Automatically opens the mini player when you scroll to the comments section'
        },
